import LoginPage from '@/components/Acess/login-page.vue'
import NotFoundPage from '@/components/Acess/not-found-page.vue'
import RegisterPage from '@/components/Acess/register-page.vue'
